 ...
 *
 * The service pages only earn search traffic if the HTML a crawler receives
 * already contains the content. A client-rendered SPA ships an empty
 * <div id="root">, so every service page would look identical and empty.
 */
...
for (const route of ROUTES) {
  ...
  const head = [
    ...
    `<meta property="og:site_name" content="Jai Civil Limited" />`,
    `<meta property="og:locale" content="en_NZ" />`,
    // No og:image / twitter:card yet: those tags promise an image that must
    // actually exist. Add them when a real og-image.jpg is in /public.
